...
export const verticals: Vertical[] = [
  // 1 — Tech (blue)
  {
    ...
    subNiches: [
      makeSubNiche('Artificial Intelligence', ['AI Tools', 'AI Productivity', 'AI Tutorials', 'AI Comparisons', 'Prompt Engineering', 'AI Agents', 'AI Automation']),
  ...
  // 3 — Finance (green)
  {
    ...
    subNiches: [
      ...
      makeSubNiche('Taxes & Administration', ['Tax Basics', 'Tax Tools', 'Personal Admin', 'Invoices', 'Financial Documents']),
  ...
  // 7 — Health (rose)
  {
    ...
    subNiches: [
      ...
      makeSubNiche('Mental Health', ['Stress', 'Anxiety Basics', 'Focus', 'Burnout', 'Journaling', 'Mindfulness']),
  ...
  // 8 — Travel (sky)
  {
    ...
    subNiches: [
      ...
      makeSubNiche('Digital Nomad Life', ['Remote Work Travel', 'Nomad Cities', 'Workspaces', 'Visas', 'Nomad Tools']),
  ...
  // 9 — Society (slate)
  {
    ...
    subNiches: [
      ...
      makeSubNiche('Rights & Law', ['Consumer Rights', 'Privacy Rights', 'Work Rights', 'Legal Basics', 'Everyday Law']),
